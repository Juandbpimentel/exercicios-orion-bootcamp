...
INSERT INTO alunos(nome, email, curso_id) VALUES
    ...
    ('Rafael Costa', 'rafael.costa@email.com', 3),
    ('Camila Martins', 'camila.martins@email.com', 4);
